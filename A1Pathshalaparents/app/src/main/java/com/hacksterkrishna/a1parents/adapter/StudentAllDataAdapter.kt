...
import com.hacksterkrishna.a1parents.activity.AttendanceActivity
...
class StudentAllDataAdapter(private val student: ArrayList<Student>) : RecyclerView.Adapter<StudentAllDataAdapter.ViewHolder>() {

    private var utils = Utils()

    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ViewHolder {
        val view = LayoutInflater.from(viewGroup.context).inflate(R.layout.stdall_card, viewGroup, false)
    ...
    inner class ViewHolder(itemView: View, var studentDetail:Student?=null) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.setOnClickListener{
                ...
                val intent = Intent(itemView.context, AttendanceActivity::class.java)
                intent.putExtra(Constants.STDID,studentDetail?.sid)

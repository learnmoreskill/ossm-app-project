...
import com.hacksterkrishna.a1parents.adapter.StudentAllDataAdapter
...
class StudentsFragment : Fragment(), AnkoLogger {

    private var std_data: java.util.ArrayList<Student>? = null
    private var std_adapter: StudentAllDataAdapter? = null
    private var mCompositeDisposable: CompositeDisposable? = null
    private var pref: SharedPreferences? = null
    private var Base_url: String?=null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        activity.title = "Students"
    ...
    private fun handleResponse(resp: ServerResponse) {
        ...
        if (resp.result == Constants.SUCCESS) {
            ...
            std_adapter = StudentAllDataAdapter(std_data!!)

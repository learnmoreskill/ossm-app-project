...
class DashboardFragment : Fragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        if (!isNullOrEmpty(pref!!.getString(Constants.NAME,""))){
            tv_father_name.text=pref!!.getString(Constants.NAME,"")!!.trim().capitalize()
        }else{ tv_father_name.visibility = View.GONE }

        if (!isNullOrEmpty(pref!!.getString(Constants.MNAME,""))){
            tv_mother_name.text=pref!!.getString(Constants.MNAME,"")!!.trim().capitalize()
        ...
        if (!isNullOrEmpty(pref!!.getString(Constants.PROFESSION,""))){
            tv_db_profession.text=pref!!.getString(Constants.PROFESSION,"")!!.trim().capitalize()
        ...
        if (!isNullOrEmpty(pref!!.getString(Constants.ADDRESS,""))){
            tv_db_address.text=pref!!.getString(Constants.ADDRESS,"")!!.trim().capitalize()
        }else{ layout_address.visibility = View.GONE }

        tv_db_school.text=pref!!.getString(Constants.SCHOOLNAME,"")!!.trim().capitalize()

...
class AttendanceFragment : Fragment(), AnkoLogger {
    ...
    private fun setAttendanceList(){
        ...
        pref = activity.getSharedPreferences("parentPrefs", Context.MODE_PRIVATE)
        val sid:String = pref!!.getString(Constants.PARENTID,"Sid")   //change parentis to student id
        ...
        val request = ServerRequest(Constants.FETCH_ATTENDANCE,parent,null,null,null,null)

...
cp app/build/outputs/apk/release/WPparents-*.apk app/build/outputs/apk/release/WPparents-"$version_name"_"$sha_hash".apk
apk=app/build/outputs/apk/release/WPparents-"$version_name"_"$sha_hash".apk
...
tg_message="[$sha_hash](https://github.com/ishubhamsingh/WPparents_client/commit/$sha_hash) passed"
  else
  
tg_message="[$sha_hash](https://github.com/ishubhamsingh/WPparents_client/commit/$sha_hash) failed"
  fi

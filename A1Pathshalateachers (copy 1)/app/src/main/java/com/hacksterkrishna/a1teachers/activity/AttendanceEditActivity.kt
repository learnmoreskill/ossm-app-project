...
class AttendanceEditActivity: AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("class",standard+sec+teacherId+teacherName)
    ...
    private fun handleResponse(resp: ServerResponse) {
        ...
        if (resp.getResult() == Constants.SUCCESS) {
            ...
            btn_attendance_edit_submit.setOnClickListener{
                ...
                if (teacherId==pref!!.getInt(Constants.ID,0).toString()) {
                    ...
                    }else{ longSnackbar(attendance_edit_layout,"Sorry, You dont have permission to edit..")
                    }
                }
            }
